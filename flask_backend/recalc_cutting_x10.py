...
================================================================
※ Task N（2026-07-13）起，**主要路徑＝admin 管理頁 `/admin/recalc-cutting`**
  （預覽→確認→自動備份→可還原，不派發 cmd 到生產機）。本腳本保留為**備援/離線**用途；
  邏輯已復用為後端函式 database.recalc_cutting_preview/apply/backups/rollback。
================================================================
