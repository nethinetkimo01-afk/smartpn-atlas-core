...
Status: **DRAFT — 未經 Jim 批准（中樞草稿）**。2026-07-14 Jim 裁示：本檔為中樞草稿、**未批准**，
**不得作為任何實作/驗收依據**。SmartPN demo 的唯一規格基準＝`16_S02_TO_S17_COMPLETE_SPECS.md`（Jim 原始規格）。
（起因：Demo v3 有畫面無機制。43號檔管治理原則，本檔管運作機制——僅供參考，待 Jim 批准前不生效。）
