...
### 人為差異分類（2026-06-08）— 41 筆總計

**分類規則：**
- 類別1（不處理）：|差異| < 廠務 × 20%
- 類別2（疑似成型进度段未修正）：auto / 廠務 ≈ 1.75–2.30x
- 類別3（異常大差異）：|差異| > 廠務 × 50%

**類別1：時間差，不處理（3 筆）**

| ART | LEAN | auto | 廠務 | 差 | 比例 |
|-----|------|-----:|-----:|---:|-----:|
| GV6894 | 2C | 7,975 | 6,671 | +1,304 | 1.20x |
| JQ0597 | 7B | 6,282 | 5,268 | +1,014 | 1.19x |
| KI5241 | 10C | 2,714 | 2,317 | +397 | 1.17x |

**類別2：疑似成型进度段取捨問題（8 筆）— 需 Jim 確認**

| ART | LEAN | auto | 廠務 | 差 | 比例 |
|-----|------|-----:|-----:|---:|-----:|
| IG6045 | 6A | 33,906 | 17,823 | +16,083 | 1.90x |
| HQ2806 | 3A | 5,930 | 2,698 | +3,232 | 2.20x |
| KI1388 | 1A | 5,889 | 2,830 | +3,059 | 2.08x |
| KH9683 | 3A | 5,930 | 3,232 | +2,698 | 1.83x |
| KI8402 | 11A1 | 3,784 | 1,716 | +2,068 | 2.21x |
| KI4569 | 6B | 3,164 | 1,443 | +1,721 | 2.19x |
| KJ0690 | 9C | 1,352 | 640 | +712 | 2.11x |
| KJ5221 | 7B | 1,257 | 698 | +559 | 1.80x |

> 注意：KI1388 1A = 5,889 是 4 個 CODECHAOS 27 ART 合併後，廠務只記 KI1388 = 2,830，故呈現 ≈2x，非真正成型进度問題。

**類別3：異常大差異（21 筆）— 需 Jim 確認**

| ART | LEAN | auto | 廠務 | 差 | 比例 |
|-----|------|-----:|-----:|---:|-----:|
| KI5734 | 1B | 15,473 | 395 | +15,078 | 39.2x |
| KI5737 | 1B | 15,473 | 1,065 | +14,408 | 14.5x |
| KZ6449 | 9B | 7,616 | 16,804 | −9,188 | 0.45x |
| KI5738 | 1B | 9,431 | 700 | +8,731 | 13.5x |
| KI5741 | 1B | 9,431 | 1,475 | +7,956 | 6.4x |
| KH9679 | 3A | 8,508 | 900 | +7,608 | 9.5x |
| HP4218 | 8B | 7,247 | 172 | +7,075 | 42.1x |
| KJ7499 | 7B | 6,282 | 331 | +5,951 | 19.0x |
| KJ4381 | 3A | 5,864 | 135 | +5,729 | 43.4x |
| HQ3330 | 7A | 2,725 | 8,451 | −5,726 | 0.32x |
| KH9677 | 3A | 5,864 | 475 | +5,389 | 12.4x |
| KI3584 | 7B | 6,282 | 2,131 | +4,151 | 2.95x |
| KK2445 | 3A | 5,204 | 1,822 | +3,382 | 2.86x |
| KJ7511 | 11B1 | 4,526 | 1,269 | +3,257 | 3.57x |
| KK2572 | 11A2 | 2,864 | 300 | +2,564 | 9.55x |
| KH9648 | 5C | 3,519 | 1,231 | +2,288 | 2.86x |
| KJ1669 | 9C | 2,289 | 636 | +1,653 | 3.60x |
| KJ1672 | 9C | 3,299 | 1,914 | +1,385 | 1.72x |
| KJ0645 | 6B | 1,483 | 140 | +1,343 | 10.6x |
| KJ5770 | 2C | 2,040 | 1,342 | +698 | 1.52x |
| KI4563 | 6B | 1,393 | 800 | +593 | 1.74x |

**其他（差異 20–50%，非 ÷2 關係）：9 筆 — 需人工核查**

| ART | LEAN | auto | 廠務 | 差 | 比例 |
|-----|------|-----:|-----:|---:|-----:|
| HQ7468 | 5B | 12,083 | 21,757 | −9,674 | 0.56x |
| JQ0598 | 2B | 4,602 | 8,472 | −3,870 | 0.54x |
| HQ4909 | 9C | 1,865 | 3,664 | −1,799 | 0.51x |
| JQ9824 | 9C | 1,608 | 3,216 | −1,608 | 0.50x |
| KK2621 | 7B | 2,358 | 3,777 | −1,419 | 0.62x |
| KJ8377 | 8C | 1,366 | 2,284 | −918 | 0.60x |
| KJ7539 | 7B | 2,730 | 1,854 | +876 | 1.47x |
| KJ1674 | 5C | 2,012 | 2,715 | −703 | 0.74x |
| KJ7543 | 7B | 3,884 | 3,211 | +673 | 1.21x |
...
- 類別2 **8** 筆 — 確認是否成型进度段問題
- 類別3 **21** 筆 — 確認廠務數字或 DS-04 來源
- 其他 **9** 筆 — 廠務數字偏高（auto < 廠務），確認排產是否已更新
