...
Jim = Direction, Decision, Client Development, Persuasion
Claude = Central Brain: Analysis, Discussion, Breakdown, Assignment, Coordination
Tools = Execute what they are best at

`
Jim (direction + decisions)
??Claude (central brain: analyze, discuss, break down, assign)
??Each tool does what it does best:
- ChatGPT ??image generation
- Codex ??code, PPT refinement
- Make ??automation execution
- Search tools ??intelligence gathering
